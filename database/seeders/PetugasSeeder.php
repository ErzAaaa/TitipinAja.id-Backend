    ...
    public function run(): void
    {
        DB::table('petugas')->insert([
            [
                ...
                // TAMBAHKAN EMAIL (Ini yang dipakai buat login)
                'email'        => 'admin@parkir.com', 
                // Username boleh tetap ada kalau kolom di DB masih ada
                'username'     => 'admin', 
            ...
            [
                ...
                'email'        => 'rina@parkir.com', // Login pakai ini
                'username'     => 'rina',
            ...
            [
                ...
                'email'        => 'joko@parkir.com', // Login pakai ini
                'username'     => 'joko',
